...
class LogMessage : public OutMessage, protected FEData, public ostringstream
{
public:
...
class Warning : public OutMessage, protected FEData, public ostringstream
{
  // Do *NOT* mess with the ostrstream directly, unless you like debugging.
  // It is imported publicly only to get the existing << operators.
...
class Message : public OutMessage, protected FEData, public ostringstream
{
...
class InvokingMessage : public OutMessage, protected FEData, public ostringstream
{
