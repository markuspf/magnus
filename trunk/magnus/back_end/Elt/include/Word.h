...
//
// * 3/06 Roman K. added members bool isEmpty( ) and Word power( int )
//
...
///////////////////////////////////////////////////////////////////////
  ...
  Word power( const int j ) const;
  // Return jth power of *this
  // the result is not freely reduced
...
public:
  ...
  operator Generator( ) const { return wref.look()->val(index); }

//  static inline int abs(const Genref& gr);
  
private:

friend class Word; //@rn only op[] when possible.
//friend inline int abs(const Genref& gr);
