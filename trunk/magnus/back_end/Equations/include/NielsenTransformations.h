...
// std::ostream routines

inline std::ostream& operator <<(std::ostream& o, const ElementaryRegularAuto& era) {
  o << era.x() << " -> " << era.x() << " " << era.y();
  return o;
}

inline std::ostream& operator <<(std::ostream& o, const RegularAuto& ra) {
  o << ra.getAutoList() << std::endl;
  return o;
}

inline std::ostream& operator <<(std::ostream& o, const ElementarySingularEndo& era) {
  o << era.gen() << " -> 1 ";
  return o;
}

inline std::ostream& operator <<(std::ostream& o, const SingularEndo& ra)
{
