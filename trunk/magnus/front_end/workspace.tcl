##
##   $Id: workspace.tcl 232 2007-04-02 18:41:56Z ybryukhov $
##
...
#    if { ![info exist workspace_objectDependencies($icon)] } return
  ...
  $c bind icon <Control-Button-1> {workspace_selectAlso}
  ...
  bind .workspace.frame2.c <Button-3> {
...
proc workspace_changeNameFontSize {sz} {
  catch {
    .workspace.frame2.c itemconfigure name \
                -font [option get .workspace.frame3.log font {}]
                -size $sz]
  }
}
