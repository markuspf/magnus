...
if {[file executable $executable]} {
  if {[makeTranscript] == 1} {
	 set sessionManager [open "| $tcl $magnus_home/front_end/copier.tcl \"$executable $magnus_home $tmp_dir\" from-frontend.log from-backend.log 2>./session.log" r+]
  } else {
	 set sessionManager [open "| $tcl $magnus_home/front_end/copier.tcl \"$executable $magnus_home $tmp_dir\" from-frontend.log from-backend.log 2>/dev/tty" r+]
  }
