##
##   $Id: greeting.tcl 232 2007-04-02 18:41:56Z ybryukhov $
##
...
#@db    .mbar.file add command -label Quit -command fakeQuit
  ...
  menu .mbar.prefs
    ...
    menu .mbar.prefs.fontsz
      addFontSizeMenu .mbar.prefs.fontsz Tiny 8
      addFontSizeMenu .mbar.prefs.fontsz Small 10
      addFontSizeMenu .mbar.prefs.fontsz Normal 12
      addFontSizeMenu .mbar.prefs.fontsz Big 14
      addFontSizeMenu .mbar.prefs.fontsz Huge 18
      addFontSizeMenu .mbar.prefs.fontsz Gigantic 24
...
proc addFontSizeMenu {w label sz} {
  $w add radiobutton -label $label \
      -value $label -variable fontSize -command "changeFontSize $sz" \
      -font [list Helvetica $sz]
}
