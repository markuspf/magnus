##
##   $Id: general.tcl 232 2007-04-02 18:41:56Z ybryukhov $
##
...
proc setHeaderTag { } {
   array set f [option get .workspace.frame3.log font {}]
        array set options {-weight bold}
        .frame3.log tag configure t -font [array get f] -justify center
