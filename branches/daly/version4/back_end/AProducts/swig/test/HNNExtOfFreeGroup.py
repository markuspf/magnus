...
g=Magnus.Group()
###
a=Magnus.HNNExtOfFreeGroup( g1, "xxw",sg,sg)
x=a.isProperPower( w1) 
x=a.conjugacyProblem(w1, w2, w1 ) 
x=a.isProperPowerOfSecond(w1, w2, 2 ) 
####Inherited From HNNExtention
x=a.getFPGroup()  
x=a.getBasisGroup( )  
x=a.stableLetter( )  
x=a.isFree( )  
...
###too complicated b=Magnus.HNNExtOfFreeGroupFromString("dsgfg")
###use ReadmeFrom
###fromFGGroup
x=a.type( );
