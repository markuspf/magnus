...
// 20030628000 TPD change type of newstate from int to ios::iostate 
// 20030628001 TPD remove ipfx call

char* getLine( istream& istr )
{
// if (!istr.ipfx(0) || (!(istr.flags() & ios::skipws) && !ws(istr))) {
  if (!(istr.flags() & ios::skipws) && !ws(istr)) {
