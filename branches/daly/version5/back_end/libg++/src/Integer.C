...
// 20030626000 TPD call to abs(long int&) is ambiguous 
...
// 20030626001 TPD remove call to opfx
...
// 20030626002 TPD remove call to opfx
// 20030626003 TPD changed stream.set to stream.setstate (2 places)
...
istream& operator >> (istream& stream, Integer& val)
{
 ...
 fail:
  ...
  return stream;
 eof_fail:
  // tpd stream.set(ios::failbit|ios::eofbit);
