...
// IO
// 20030626000 TPD remove call to ipfx 
// 20030626001 TPD change type of newstate from int to ios::iostate 

istream& operator>>(istream& s, String& x)
{
  // tpd if (!s.ipfx(0) || (!(s.flags() & ios::skipws) && !ws(s)))
...
/* 20030626002 TPD remove call to ipfx */
