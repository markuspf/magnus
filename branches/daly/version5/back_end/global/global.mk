...
# be read
default:
	@echo global.mk 4 finished default stanza
	@echo global.mk 4 DIR=${DIR}
	@echo global.mk 4 SRCDIR=${SRCDIR}
	@echo global.mk 4 OBJDIR=${OBJDIR}
	@echo global.mk 4 THISLIBDIR=${THISLIBDIR}
	@echo global.mk 4 TESTDIR=${TESTDIR}
	@echo global.mk 4 TESTEXEDIR=${TESTDIR}/bin
	@echo global.mk 4 BACKENDROOT=${BACKENDROOT}
	@echo global.mk 4 GLOBAL=${GLOBAL}
	@echo global.mk 4 THISLIB=${THISLIB}
	@echo global.mk 4 BACKENDLIBS=${BACKENDLIBS}
	@echo global.mk 4 MAINTARGETS=${MAINTARGETS}
...
$(BACKENDCOMPONENTS): % : lib%
	@echo global.mk 10 making BACKENDCOMPONENTS stanza
...
tests $(TESTS): $(BACKENDLIBS)
	@echo global.mk 11 making tests stanza with $@
	$(MAKE) -f $(GLOBAL)/compile.mk $@

# Anything not makable here gets delegated:
.DEFAULT:
	@echo global.mk 12 making .DEFAULT stanza
	$(MAKE) -f $(GLOBAL)/compile.mk $@
