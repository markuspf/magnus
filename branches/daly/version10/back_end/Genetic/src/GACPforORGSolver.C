...
// Revision History:
//  by xuxw:(06/21/2001)
//       change the name of valuable "ANY" to "ANYONE" because it doesn't work with SWIG
//
...
const int GACPforORGSolverGene::ANYONE = 65534;
...
void GACPforORGSolverGene::check( )
{
  ...
  if( curExp!=exp && exp!=ANYONE && exp!=NOONE ) {
