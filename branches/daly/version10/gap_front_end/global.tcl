...
proc set_viewParameter {viewID parameters} {
  global viewData
  set viewData($viewID,parameters) $parameters
}

proc get_viewParameter {viewID} {
  global viewData
  return $viewData($viewID,parameters)
}
#
...
proc set_edge {edges source target destination } {
    global workspace_edgeSources workspace_edgeTargets
    global dest
...
proc logScrollAppend { logName message {tagList ""} } {
  ...
  global logHoldView
#define ~newline as return
  regsub -all ~newline $message "\n" message 
