...
void MatrixComputations<Integer>::abolishCoefficients(Matrix<Integer>& matrix )
{
  int realSize = size() * 2;
  for( int i = 0; i < size(); i++ )
...
void MatrixComputations<Rational>::abolishCoefficients(Matrix<Rational>& matrix )
{
  int realSize = size() * 2;
  for( int i = 0; i < size(); i++ )
...
void MatrixComputations<double>::abolishCoefficients(Matrix<double>& matrix )
{
  int realSize = size() * 2;
  for( int i = 0; i < size(); i++ )
