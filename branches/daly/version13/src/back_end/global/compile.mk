...
ALLBACKENDCOMPONENTS = SessionManager SMApps Packages Enumerators Apps GAP Calculus Statistics AProducts NilpotentGroup Todd-Coxeter Genetic Map Subgroup Equations Group Polynomial Matrix KB FSA Elt general libg++
...
# The Python library
LIBPYTHON = #/usr/bormotov/python/Python-2.1b2a/libpython2.1.a
LIBP = -lnsl -ldl -lreadline -ltermcap -lieee -lpthread -lutil

LDFLAGS = $(LIBPYTHON) $(LIBP) -lm -static
...
$(OBJDIR)/%.d: %.C
	...
	$(SHELL) -ec '$(CC) -MM $(INCLUDE) $< | sed "s:$*.o:$(OBJDIR)/& $@:g"' > $@
