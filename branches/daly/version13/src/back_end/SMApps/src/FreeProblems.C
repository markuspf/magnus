...
{
  ProblemView pv( ostr, oid(), "Is finite automorphism",
...
{
  ProblemView pv( ostr, oid(), "Does contain a conjugate",
...
{
  ProblemView pv( ostr, oid(), "Are conjugate ?",
...
{
  ProblemView pv( ostr, oid(), "Enumerate automorphisms",
  ...
  pv.add("For the use of this enumerator", ThisARCSlotID(), 50);
