...
{
  ProblemView pv( ostr, oid(), "Is subgroup abelian problem",
...
{
  ProblemView pv( ostr, oid(), "Is subgroup central problem",
...
void IsSGNilpotent::viewStructure(ostream& ostr) const
{
  ...
  ProblemView pv( ostr, oid(), "Is subgroup nilpotent problem",
...
{
  ProblemView pv( ostr, oid(), "Subgroup triviality problem",
		  Text("Is the subgroup") + Name( theSubgroup ) + "of"
...
{
  ProblemView pv( ostr, oid(), "Subgroup presentation problem",
  ...
  pv.add("Approximation method", am.arcSlotID(), 45 );

  pv.add("Compute Schreier transversal", sgToddCoxeter.arcSlotID(), 45 );

  pv.add("Method that uses Todd-Coxeter procedure", tcm.arcSlotID(), 10 );
...
{
  ProblemView pv( ostr, oid(), "Rewriting of a word in terms of Schreier generators",
