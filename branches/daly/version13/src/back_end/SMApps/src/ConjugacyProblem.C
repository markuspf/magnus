...
{
  ProblemView pv( ostr, oid(), "Conjugacy problem",
  ...
  pv.add("Try graph method", fpConjugacyWrapper.arcSlotID(), 100);

  pv.add("Try small cancellation method", mscConjugacyWrapper.arcSlotID(), 60);
  ...
  pv.add("Try genetic algorithm", GAConjugacy.arcSlotID(), 60);
