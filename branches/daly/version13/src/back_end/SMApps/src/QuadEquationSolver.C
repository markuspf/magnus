...
{
  ProblemView pv( ostr, oid(), "Solving a quadratic equation",
  ...
  if( !equation.eic.isSolved() )
    pv.add("To find basic solutions", basicSubordinate.arcSlotID(), 100);

  pv.add("To generate random solutions", randomSubordinate.arcSlotID(), 100);
...
{
  ProblemView pv( ostr, oid(), "Quick solving a quadratic equation",
  ...
  pv.add("To use for this problem", basicSubordinate.arcSlotID(), 100);
