...
{
  ProblemView pv( ostr, oid(), "Compute the Hirsch number",
...
{
  ProblemView pv( ostr, oid(), "Compute the nilpotency class",
...
{
  ProblemView pv( ostr, oid(), "Is the group free nilpotent?",
...
{
  ProblemView pv( ostr, oid(), "Decompose word in terms of a basis",
...
{
  ProblemView pv( ostr, oid(), "Decide if word is in the commutator subgroup",
...
{
  ProblemView pv( ostr, oid(), "Term of the lower central series problem",
...
{
  ProblemView pv( ostr, oid(), "Compute the presentation",
  ...
  pv.add("For the use of this problem", ThisARCSlotID(), 100);
  pv.done();
}
...
{
  ProblemView pv( ostr, oid(), "Test for an automorphism being an IA-automorphism",
...
{
  ProblemView pv( ostr, oid(), "Central element problem",
...
void NGMaximalRootProblem::viewStructure(ostream& ostr) const
{
  ...
  pv.add("Compute maximal root", ThisARCSlotID(), 100);
  pv.done();
}
...
void NGIsProperPower::viewStructure(ostream& ostr) const
{
  ...
  pv.add("For use of this problem", ThisARCSlotID(), 100);
  pv.done();
}
...
{
  ProblemView pv( ostr, oid(), "Compute the centralizer of element",
  ...
  pv.add("Compute the centralizer ", ThisARCSlotID(), 100);
  pv.done();
}
...
{
  ProblemView pv( ostr, oid(), "Nilpotent isomorphism problem",
