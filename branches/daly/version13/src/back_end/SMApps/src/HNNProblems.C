...
{
  ProblemView pv( ostr, oid(), "Is an HNN-extension of free group free",
  ...
  pv.add("For use of this problem", 
	 ThisARCSlotID(), 
	 50
	 );
...
{
  ProblemView pv( ostr, oid(), "Is an amalgamated product of free groups free",
...
{
  ProblemView pv( ostr, oid(), "Is an amalgamated product of free groups perfect",
		  Text("Is an amalgamated product ") + Name( theGroup ) 
...
{
  ProblemView pv( ostr, oid(), "Integral homology of an amalgamated product of free groups",
