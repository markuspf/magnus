...
{
  ProblemView pv( ostr, oid(), "Is part of free basis problem",
  ...
  pv.add("For the use of the genetic algorithm", gaIsPartOfBasisCM.arcSlotID(), 100);
...
void FreeGeneralIsPartOfBasisProblem::viewStructure(ostream& ostr) const
{
  ...
  pv.add("For the use of this problem", freeIsPartOfBasis.arcSlotID(), 100);
