...
class GraphicView : public FEData
{
public:

  GraphicView(ostream& o, OID oid, const Text& title, const Text& banner,
	      const char* helpID = "none", const Chars abbreviation = "none");
...
class SummaryView : public FEData
{
public:

  SummaryView(ostream& o, OID oid, const Text& title, const Text& banner,
	      const char* helpID = "none", const Chars abbreviation = "none");
...
//--------------------------- ResultView -----------------------------------//
//---------------------------------------------------------------------------//
class ResultView : public FEData
{
public:

  ResultView(ostream& o, OID oid, const Text& title, const Text& banner,
	      const char* helpID = "none", const Chars abbreviation = "none");
  void done( );
