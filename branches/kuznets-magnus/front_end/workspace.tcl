##
##   $Id: workspace.tcl 9 2005-01-23 05:27:26Z daly $
##
...
proc makeWorkspace {} {
  ...
  menubutton $w.mbar.make -text "Make" -menu $w.mbar.make.menu -padx 1m
  menubutton $w.mbar.packages -text "Packages" -menu $w.mbar.packages.menu -padx 1m

  menubutton $w.mbar.database -text "Database" -menu $w.mbar.database.menu \
    -padx 1m

  if { [inTestingMode] == 1 } {
      menubutton $w.mbar.testing -text "Testing" -menu $w.mbar.testing.menu \
	      -padx 1m
  }
  menubutton $w.mbar.help -text Help -menu $w.mbar.help.menu -padx 1m

  pack $w.mbar.checkin $w.mbar.tools $w.mbar.make $w.mbar.packages \
       $w.mbar.database $w.mbar.testing -side left -padx 1m
  ...
  menu $w.mbar.make.menu

  menu $w.mbar.packages.menu

  menu $w.mbar.database.menu

  menu $w.mbar.testing.menu 
