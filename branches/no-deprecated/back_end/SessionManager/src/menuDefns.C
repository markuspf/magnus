...
{
  {
    ...
    */
    ...
    M.add( ReadAffineItem(),
	   Text("Find the affine algebraic set of representations of") + Name(1),
	   DefineInt("What representation degree?",2) );
...

  {
    ...
    M.add( Ctor1<SGOfFreeHallCompletion,SMSubgroup>(),
	   Text("Find a finite index subgroup of") + Name( Parent(1) )
	   + "containing" + Name(1) + "as a free factor" );
