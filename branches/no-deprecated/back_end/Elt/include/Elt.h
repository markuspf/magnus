...
///////////////////////////////////////////////////////////////////////
  ...
  friend std::ostream& operator << ( std::ostream&, const Elt& );

  void debugPrint( std::ostream& o ) const; // mixed pseudo-virtual
  ...
  friend std::ostream& operator < ( std::ostream& ostr, const Elt& e )
  {
    e.look()->write(ostr);
    return ostr;
  }
  
  friend std::istream& operator > ( std::istream& istr, Elt& e )
  {
    e.change()->read(istr);
    return istr;
  }
