...
public:
 ...
 /////////////////////////////////////////////////////////////////////////
  ...
  friend std::ostream& operator < ( std::ostream& ostr, const Association& A )
  {
    ostr < A.key;
    ostr < A.val;
    return ostr;
  ...
  friend std::istream& operator > ( std::istream& istr, Association& A )
  {
    istr > A.key;
    istr > A.val;
    return istr;
...
public:
  ...
  friend std::ostream& operator < ( std::ostream& ostr, const AssociationsOf& A )
  {
    A.look()->write(ostr);
    return ostr;
  }
  
  friend std::istream& operator > ( std::istream& istr, AssociationsOf& A)
  {
    A.change()->read(istr);
    return istr;
  }
...
public:
  ...
  friend std::ostream& operator < ( std::ostream& ostr, const AssociationsIterator& AI )
  {
    AI.look()->write(ostr);
    return ostr;
  }
  
  friend std::istream& operator > ( std::istream& istr, AssociationsIterator& AI)
  {
    AI.change()->read(istr);
    return istr;
  }
...
template <class Key, class Val> inline std::ostream& operator <<
	( std::ostream& o, const AssociationsOf<Key,Val>& a ) {
