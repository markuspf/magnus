...
private:
  ...
  std::ofstream* streamToCommand;   // Bound to command's cin, or NULL
  std::ifstream* streamFromCommand; // Bound to command's cout, or NULL

//  char file_in[L_tmpnam];      // Name of pipe bound to command's cin
//  char file_out[L_tmpnam];     // Name of pipe bound to command's cout
  char file_in[100];      // Name of pipe bound to command's cin
  char file_out[100];     // Name of pipe bound to command's cout
