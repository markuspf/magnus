...
public:
  ...
  friend std::ostream& operator < ( std::ostream& ostr, const UniformRandom& unRand )
  {
  ...
  friend std::istream& operator > ( std::istream& istr, UniformRandom& unRand)
  {
    istr > unRand.ix1 > unRand.ix2 > unRand.ix3;
...
public:
  ...
  friend std::ostream& operator < ( std::ostream& ostr, const NormalRandom& noRand )
  {
  ...
  friend std::istream& operator > ( std::istream& istr, NormalRandom& noRand)
  {
