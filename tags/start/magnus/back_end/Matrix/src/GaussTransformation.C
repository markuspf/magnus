/*
 *   $Id: GaussTransformation.C 4 2005-01-07 00:28:20Z daly $
 */
...
void GaussTransformation<double>::makeZero( int& row1, int& row2 )
{
  addRow(row2, row1, -matrix[row2][currentCol] / matrix[row1][currentCol]);
}
...
void GaussTransformation<Integer>::runWhileDiagHasSingles(){
...
Trichotomy GaussTransformation<Integer>::isInvertible() const 
{
